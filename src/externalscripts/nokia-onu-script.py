...
def run_snmpwalk(community, host_ip, oid):
    command = ["snmpbulkwalk", "-v2c", "-c", community, host_ip, oid]
...
ifdescr_output = run_snmpwalk(community, host_ip, "1.3.6.1.4.1.637.61.1.35.11.2.1.19")
ifoperstatus_output = run_snmpwalk(community, host_ip, "1.3.6.1.4.1.637.61.1.35.11.4.1.5")
